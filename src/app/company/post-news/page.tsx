...
import { uploadTour } from '@/app/api/upload-tour'
...
export default function NewProjectPage() {
    ...
    const handleSubmit = async () => {
        ...
        // Chuyển thư mục ảnh
        await fetch('/api/move-image360', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ userId: userInfor.userId, projectId }),
        });
        console.log(data)
    ...
    return (
        <div className="mx-auto p-6 space-y-6 flex flex-col items-center">
            ...
            <div className="flex gap-4">
                <input placeholder="Ngày khởi hành" value={departureDate} onChange={(e) => setDepartureDate(e.target.value)} />
            ...
            <div>
                ...
                <BlockImage360 userId={userInfor.userId} onScenesChange={setScenes} />
            </div>
