    ...
    return (
        <div className="bg-slate-200 pb-10 bg-color-dark dark:bg-[black] dark:border-t">
            <div className="m-auto px-7 py-3 pt-10 w-full xl:w-1200px">
                <img src="/images/logo-site.png" alt="logo-site" className="h-auto w-auto" width={200} height={62} />
                    ...
                    <div className="flex flex-col gap-4 md:flex-row md:gap-12 lg:gap-7 xl:gap-28">
                        <div className="flex flex-col gap-2 ml-1">
                            ...
                            <div className="flex gap-1 mt-2">
                                <img src='/images/bo-cong-thuong.webp' alt="bo-cong-thuong" height={60} width={160} className="mr-2 h-auto"/>
                                <img src='/images/bo-cong-thuong2.webp' alt="bo-cong-thuong" height={60} width={160} className="h-auto"/>
                            </div>
                        </div>
